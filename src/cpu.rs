...
//! The U880 CPU struct and its primary interface: [`U880::new`], [`U880::tick`], and [`U880::reset`].
...
/// A U880 CPU.
///
/// Construct one with [`U880::new`] and advance it one clock cycle at a time
/// with [`U880::tick`]. Registers and flags are reachable through the public
/// [`regs`](U880::regs) field.
